...
usage() {
	echo "Usage: release.sh [-cdelzLCWHosu] [-t topdir] [-r releasedir] [-p curse-id] [-w wowi-id] [-w wowi-id-test] [-g game-version] [-m pkgmeta.yml]" >&2
...
OPTIND=1
while getopts ":celzdLCWHosut:r:p:w:b:g:m:" opt; do
	case $opt in
	c)
